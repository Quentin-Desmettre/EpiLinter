...
exports.errorCodeToExplanation = {
    ...
    "C2": "Improper use of ternary operator.",
    ...
    "F7": "Structures must be passed to functions using a pointer, not by copy.",
    "F8": "Functions should not contain any comment.",
    "F9": "Forbidden feature: nested functions.",
    "G10": "Inline assembly must never be used.",
    ...
    "H3": "Macros must match only one statement, and fit on a single line.",
    "L1": "A line must correspond to only one statement.",
    ...
    "L5": "Variables must be declared at the beginning of the function.",
    "L6": "Missing / Improper breakline.",
    ...
    "V3": "Badly placed pointer asterisk.",
};
